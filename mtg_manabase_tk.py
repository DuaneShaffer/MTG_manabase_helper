...
card_images_frame = ScrollableFrame(root)
...
with open('/mnt/c/Users/dlshaffer/Downloads/lands_data.json', 'w') as lands_file:
    json.dump(unique_lands, lands_file)


all_labels=[card(card_images_frame.scrollable_frame, land, TotalManaCounts) for land in unique_lands]
